...
[![单文件组件的示例 (点击查看文本版的代码](https://cn.vuejs.org/images/vue-component.png)](https://codesandbox.io/s/github/vuejs/vuejs.org/tree/master/src/v2/examples/vue-20-single-file-components)
